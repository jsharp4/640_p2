...
class Router(object):
    ...
    def router_main(self):    
        ...
        while True:
                ...
                if pkt.has_header(Arp):
                        ...
                        if arp.operation == ArpOperation.Request:
                            ...
                            for i in range(self.pkt_queue.qsize()):
                                ...
                                if  int(dequeue_pkt.next_hop) == int(arp.senderprotoaddr):
                                    log_debug("BBBBBBBBBBBBBB QUEUE " + str(dequeue_pkt.next_hop))
                                    log_debug("WWWWWWWWWWWWWW QUEUE " + str(arp.senderprotoaddr))
                    ...
                    for i in range(0, 5):
                        ...
                        if entry is None:
                            ...
                            if self.dynamic_fwd_table[5] is None:
                                ...
                                log_debug("XXXXXXXXXXXXXXXXXXXXXXXXXXXXX " + str(oldest_index))
                            break
                        elif i == 4:
                    ...
                    for dynamic_entry in self.dynamic_fwd_table:
                        ...
                        if matches:
                            ...
                            log_debug("FFFFFFFFFFFFFFFFFFFFFFF " + next_name + " " + str(next_hop))
                            log_debug("GGGGGGGGGGGGGGGGGGGGGGG " + str(destaddr))
                            break
                    if next_hop == '':
                        for entry in self.forwarding_table:
            ...
            #for i in range(0, len(self.dynamic_fwd_table)):
                #log_debug('############'+str(self.dynamic_fwd_table[i]))
