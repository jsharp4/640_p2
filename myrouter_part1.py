...
class Router(object):
    def __init__(self, net):
        ...
        mac_ip_dict = dict((intf.ipaddr, intf.ethaddr) for intf in my_interfaces)
        ...
        while True:
            ...
            try:
                ...
                if pkt.has_header(Arp):
                    ...
                    if arp.targetprotoaddr in my_ips:
                        senderhwaddr = mac_ip_dict[my_ips]
